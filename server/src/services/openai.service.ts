...
import type { GeneratedLandingPage, LandingPageContent } from '../types';
...
Return JSON with this EXACT structure:
{
  ...
  "content": {
    ...
    "stats": [
      { "value": "Impressive number", "label": "Relevant metric (e.g., '10K+ Users', '99.9% Uptime', '500+ Projects')" },
...
- Use industry-appropriate emojis for icons (🚀 for tech, 🍕 for food, ⚖️ for law, etc.)
...
Return ONLY valid JSON. No markdown formatting, no explanations.`;
    ...
    try {
      ...
      const parsed = JSON.parse(cleaned) as GeneratedLandingPage;
  ...
  private validateAndFillDefaults(
    ...
    // Merge with defaults
    const safeContent: LandingPageContent = {
